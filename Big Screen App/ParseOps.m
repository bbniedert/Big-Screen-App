...
static int currentRoundToRender = 0;
...
{
    self = [super init];
    self.firstScheduleGenerated = NO;
    if (self) {
...
-(int)getRoundToGet{
    int retValue = currentRoundToRender;
    currentRoundToRender++;
    if (currentRoundToRender >= 11){
        currentRoundToRender = 0;
    }
    return retValue;
}
